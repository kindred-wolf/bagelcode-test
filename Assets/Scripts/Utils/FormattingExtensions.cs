...
namespace Game.Scripts.Utils.Extensions
{
	public static class FormattingExtensions
	{
		...
		/// <summary>
		/// Возвращает форматированную строку оставшегося времени
		/// 1d 23h, 23h 59m, 59:59
		/// </summary>
		/// <param name="remainingTime">Оставшееся время в секундах</param>
		/// <param name="extenedTime">Формат: 1d 23h 59m</param>
		/// <returns></returns>

		public static string ToFormattedTimer(this float remainingTime, bool extenedTime = false)
		{
			...
			if(extenedTime)
				return $"{days:00}d {hours:00}h {minutes:00}m";
